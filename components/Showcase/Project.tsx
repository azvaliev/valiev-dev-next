...
const Project = ({
	...
	return (
		<div
			className="flex flex-col lg:flex-row max-w-[100vw] pt-2 sm:py-4 overflow-hidden"
			key={key}
		>
			{left || isMobile ? (
				<div
					className={`relative m-auto transition-all hover:scale-110 sm:hover:translate-x-2 lg:h-[70vh] lg:w-[40vw] w-[80vw] h-[35vh] `}
				>
					<Image
						src={mockup}
						alt={alt}
			...
			<div className="flex flex-wrap flex-col mx-auto lg:ml-4 w-[90vw] md:max-w-[90vw] max-h-[95vh] sm:max-h-[80vh] lg:max-w-[50vw] shadow-lg p-8">
				...
				<div className="flex flex-row mx-auto mt-4 mb-8">
					{github && (
						<a
							...
							target="_blank"
							rel="noopener"
							className="flex flex-row hover:filter hover:invert"
						>
				...
				<h3 className="text-3xl mx-auto lg:mt-4 mb-2 sm:mt-auto everett underline">
			...
			{!left && !isMobile ? (
				<div
					className={`relative m-auto transition-all hover:scale-110 w-[80vw] h-[35vh]`}
				>
					<Image
						src={mockup}
						alt={alt}
