 ...
 (function (root, factory) {
    ...
    */
    ...
    let embed = function(url, targetSelector, options){
        ...
        let fallbackHTML = "";
        let pdfOpenFragment = "";
        let fallbackHTML_default = '<p>This browser does not support inline PDFs. Please download the PDF to view it: <a href="[url]" target="_blank" rel="noopener">Download PDF</a></p>';
