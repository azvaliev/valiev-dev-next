		...
		return (
		  <Html>
			<Head>
				...
				<meta property="og:title" content="Azat Valiev - React Developer" />
				<meta property="og:description" content="Full Stack Web Developer with 4+ years of experience" />
				...
				<meta name="apple-mobile-web-app-title" content="Valiev Dev"/>
