	...
	return (
		<div className="flex flex-col">
			<MainBG className="-z-50">
				<Image
					src="/img/seattle2.webp"
					alt="Seattle landscape"
					aria-hidden="true"
					layout="fill"
					objectFit="contain"
					className="-z-50 bg-main"
					priority
				/>
			</MainBG>
			<IntroWrapper className="flex flex-col w-full white ">
				<div className="flex flex-col mx-auto w-full pb-2 mt-[30vh]">
					...
					<h2 className="text-2xl md:text-25xl text-black mx-8 lg:mx-auto text-center mt-2 font-medium">
						I'm a Seattle based Web Developer with experience
						in&nbsp;
						<TextLoop
							children={[
								"React JS",
					...
					<div className="border-t-1 rounded-sm pb-2 w-2/3 mx-auto border-gray-400 "></div>
			...
			<div className="mx-auto mt-2 pb-16 w-fit">
				<Button
					...
					link="/projects"
					className="text-4xl sm:text-5xl transition-all scale-100 hover:scale-110"
				/>
			</div>
